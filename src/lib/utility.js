...
utility.consulta = "SELECT a.co_usuario, a.no_usuario FROM cao_usuario AS a \
...
utility.sqlData = "SELECT b.co_usuario, c.no_usuario, YEAR( a.data_emissao ) AS anio, MONTH( a.data_emissao ) as mes, \
